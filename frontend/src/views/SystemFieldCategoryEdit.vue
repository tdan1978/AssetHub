  ...
  <div class="space-y-6">
    <div class="card">
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-base font-semibold">编辑字段分类</h2>
          <p class="text-sm text-muted-foreground">更新系统字段分类信息。</p>
        </div>
...
const save = async () => {
  ...
  await api.put(`/system-field-categories/${categoryId}`, form.value);
