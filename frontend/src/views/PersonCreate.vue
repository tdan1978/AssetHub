  ...
  <div class="space-y-6">
    <div class="card">
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-base font-semibold">新增人员</h2>
          <p class="text-sm text-muted-foreground">录入人员基本信息。</p>
        </div>
...
const loadDepartments = async () => {
  ...
  const preset = route.query.dept_id ? String(route.query.dept_id) : noneValue;
  form.value.dept_id = preset;
};
