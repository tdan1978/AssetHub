  ...
  <div class="space-y-6">
    <div class="card">
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-base font-semibold">新增系统字段</h2>
          <p class="text-sm text-muted-foreground">为系统资产添加自定义字段。</p>
        </div>
...
const save = async () => {
  ...
  await api.post(`/system-field-categories/${categoryId}/fields`, {
    ...form.value,
